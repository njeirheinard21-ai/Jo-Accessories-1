...
export function NotFound() {
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col items-center justify-center p-6 text-center selection:bg-ash selection:text-white">
      ...
      <Link 
        to="/" 
        className="inline-block border border-ash text-ash px-12 py-4 text-[10px] uppercase tracking-[0.2em] font-sans font-bold hover:bg-ash hover:text-white luxury-transition outline-none"
      >
        Return to Boutique
      </Link>
    </div>
